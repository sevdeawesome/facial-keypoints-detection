...
def create_train_test_sets_nchw(training_df, test_size=.2, normalize=False):
    ...
    # this is not how to properly normalize, and wont capture the distribution of pixels, HOWEVER, it is way easier for this dataset. So I will use it for now. Later in the pipeline this can be updated
    if normalize: 
        return X_train/255, Y_train/96, X_val/255, Y_val/96
